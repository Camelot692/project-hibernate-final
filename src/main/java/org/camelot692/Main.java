...
import org.camelot692.redis.Language;
...
public class Main {
    ...
    private RedisClient prepareRedisClient() {
        ...
        try (StatefulRedisConnection<String, String> connection = redisClient.connect()) {
            ...
            //sout доданий у навчальних цілях, щоб у лозі запуску бачити,
            // що всі ОК, і конекшн через редіс-клієнт пройшов без помилок.
            System.out.println("\nConnected to Redis\n");
    ...
    private List<CityCountry> transformData(List<City> cities) {
        return cities.stream().map(city -> {
            ...
            res.setAlternativeCountryCode(country.getCodeAlternative());
